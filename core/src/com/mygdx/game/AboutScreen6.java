...
public class AboutScreen6 extends AboutScreen {
    private TextButton nextButton;
    private TextButton prevButton;

    public AboutScreen6(SpaceBlastGame game, SoundManager sounds) {
        super(game, sounds, "aboutCombat1.png");
    }
    ...
    public void createButtons() {
        ...
        nextButton.addListener(new ChangeListener() {                
            public void changed(ChangeEvent event, Actor actor) {
                game.setScreen(game.getAboutScreen7());
                sounds.playButton();
            }
        });
